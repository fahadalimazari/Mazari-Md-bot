  ...
  sock.ev.on('creds.update', async () => {
    try {
      ...
      if (!hasBackedUpInitialRegistration) {
        ...
        console.log(chalk.green(`[PERSISTENCE CHECK] Phone: ${phoneNumber}`));
        console.log(chalk.green(`[PERSISTENCE CHECK] Local session path: ${sessionPath}`));
        console.log(chalk.green(`[PERSISTENCE CHECK] Local files: ${fs.readdirSync(sessionPath).length}`));
        console.log(chalk.green(`[PERSISTENCE CHECK] Registered: true`));
        ...
        console.log(chalk.green(`[PERSISTENCE CHECK] Supabase backup exists after write: ${success}`));
      }
