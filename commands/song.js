...
async function songCommand(sock, chatId, message) {
    ...
    try {
        ...
        try {
            ...
            console.error('[PLAY/SONG] yt-dlp primary download failed:', e.message);
        }
        ...
        if (!downloadedFilePath) {
            try {
                ...
                console.error('[PLAY/SONG] @distube/ytdl-core fallback failed:', e.message);
            }
        }
        ...
        if (!downloadedFilePath) {
            try {
                ...
                console.error('[PLAY/SONG] Third-party API fallback failed:', e.message);
            }
        }
        ...
        console.error('[PLAY/SONG ERROR] Download process failed:', err.message);
        ...
        try {
            ...
            console.error('[PLAY/SONG] Cleanup error:', cleanupErr.message);
        }
    }
}
