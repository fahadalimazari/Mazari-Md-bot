...
async function gcdesCommand(sock, msg) {
    try {
        ...
        const groupDesc = groupMetadata.desc || 'No description available for this group.';
        ...
        console.error('Error in gcdes command:', error);
        await sock.sendMessage(msg.key.remoteJid, { 
